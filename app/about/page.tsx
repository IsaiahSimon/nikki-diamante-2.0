    ...
    <main>
      ...
      <section className='border-t-2 border-slate-300 h-auto w-full  bg-gray-800 flex flex-col p-10 lg:pb-20 opacity-70'>
        <div className='lg:px-20 mb-5'>
          <p className='text-lg lg:text-3xl text-white pb-4'>
        ...
        <div className='lg:px-20'>
          <h2 className='text-4xl lg:text-5xl text-yellow-400 mb-5'>
            Nikki's Goals
          </h2>
          <p className='text-lg lg:text-3xl text-white pb-4 '>
          ...
          <div className='mt-5'>
            <Link
              href='/'
              className='hover:text-white hover:border-white w-[80px] text-center text-yellow-400 border-2 border-yellow-400 p-1 rounded text-2xl uppercase'
            >
              Home
            </Link>
          </div>
